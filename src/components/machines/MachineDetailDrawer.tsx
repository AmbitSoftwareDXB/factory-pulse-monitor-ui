...
import AckAlarmDialog from './dialogs/AckAlarmDialog';
...
const MachineDetailDrawer = ({ machine, isOpen, onClose }: MachineDetailDrawerProps) => {
  const [ackAlarmOpen, setAckAlarmOpen] = useState(false);
